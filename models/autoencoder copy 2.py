...
class FeedForwardNN:
    ...
    """
    def __init__(self, input_size=784, hidden_size=100, num_hidden_layers=1, output_size=10, learning_rate=0.01, batch_size=32, num_epochs=100, beta=0.9):
        """
    ...
    def train(self, X, Y, X_test, Y_test):
        ...
        final_train_error = self.calculate_error_fraction(self.labels.T, predictions_train)
        final_test_error = self.calculate_error_fraction(Y_test, predictions_test)
